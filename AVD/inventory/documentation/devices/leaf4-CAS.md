...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.107.218/23 | 198.18.106.1 |
...
| --------- | --------------- | ------------ | --------- |
| CAS_POD2 | Vlan4094 | 10.255.252.8 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_leaf3-CAS_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_leaf3-CAS_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-CAS_Ethernet4 | routed | - | 172.21.211.21/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-CAS_Ethernet4 | routed | - | 172.21.211.23/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_leaf3-CAS_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_leaf3-CAS_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_SPINE1-CAS_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 172.21.211.21/31
!
interface Ethernet4
   description P2P_LINK_TO_SPINE2-CAS_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 172.21.211.23/31
!
interface Ethernet5
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_leaf3-CAS_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_leaf3-CAS_Po1
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.30.211.8/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 172.31.211.7/32 |
| Loopback100 | FW_Outside_VTEP_DIAGNOSTICS | FW_Outside | 10.255.1.8/32 |
...
| Vlan3110 |  FW_Outside  |  10.255.251.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.21.211.20 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.21.211.22 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
| 10.255.251.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | FW_Outside | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 172.30.211.8:55100 | 55100:55100 | - | - | learned |
| 101 | 172.30.211.8:55101 | 55101:55101 | - | - | learned |
| 102 | 172.30.211.8:55102 | 55102:55102 | - | - | learned |
| 1110 | 172.30.211.8:50110 | 50110:50110 | - | - | learned |
| 1111 | 172.30.211.8:50111 | 50111:50111 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| FW_Outside | 172.30.211.8:111 | connected |
...
router bgp 65112
   ...
   neighbor 10.255.251.8 description leaf3-CAS
   neighbor 172.21.211.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.21.211.20 remote-as 65100
   neighbor 172.21.211.20 description spine1-CAS_Ethernet4
   neighbor 172.21.211.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.21.211.22 remote-as 65100
   neighbor 172.21.211.22 description spine2-CAS_Ethernet4
...
| -------------- | --------------------- |
| FW_Outside | 10.255.1.8 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf FW_Outside address 10.255.1.8
```
