...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 198.18.107.225/23 | 198.18.106.1 |
...
| --------- | --------------- | ------------ | --------- |
| OI_POD1 | Vlan4094 | 10.255.248.5 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_leaf2-OI_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_leaf2-OI_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-OI_Ethernet1 | routed | - | 172.21.221.9/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-OI_Ethernet1 | routed | - | 172.21.221.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_leaf2-OI_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_leaf2-OI_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_SPINE1-OI_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 172.21.221.9/31
!
interface Ethernet4
   description P2P_LINK_TO_SPINE2-OI_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 172.21.221.11/31
!
interface Ethernet5
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_leaf2-OI_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_leaf2-OI_Po1
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.30.221.5/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 172.31.221.5/32 |
| Loopback100 | FW_Outside_VTEP_DIAGNOSTICS | FW_Outside | 10.255.2.5/32 |
...
| Vlan3110 |  FW_Outside  |  10.255.247.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.247.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.248.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- |
| 10.255.247.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.21.221.8 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.21.221.10 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
| 10.255.247.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | FW_Outside | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 172.30.221.5:55100 | 55100:55100 | - | - | learned |
| 101 | 172.30.221.5:55101 | 55101:55101 | - | - | learned |
| 102 | 172.30.221.5:55102 | 55102:55102 | - | - | learned |
| 1110 | 172.30.221.5:50110 | 50110:50110 | - | - | learned |
| 1111 | 172.30.221.5:50111 | 50111:50111 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| FW_Outside | 172.30.221.5:111 | connected |
...
router bgp 65211
   ...
   neighbor 10.255.247.5 description leaf2-OI
   neighbor 172.21.221.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.21.221.8 remote-as 65200
   neighbor 172.21.221.8 description spine1-OI_Ethernet1
   neighbor 172.21.221.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.21.221.10 remote-as 65200
   neighbor 172.21.221.10 description spine2-OI_Ethernet1
...
| -------------- | --------------------- |
| FW_Outside | 10.255.2.5 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf FW_Outside address 10.255.2.5
```
